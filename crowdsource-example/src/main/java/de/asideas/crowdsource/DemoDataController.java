...
public class DemoDataController {
    ...
    public void createDemoData(Principal principal) throws Exception {
        try {
            LOG.info("Creating demo data...");
            createIdeaCampaigns(principal);
            createIdeasForCampaign(principal);
        } catch (Exception e) {
    ...
    private void createIdeaCampaigns(Principal principal) throws Exception {
        ...
        for (IdeasCampaign ideaCampaign : ideaCampaigns) {
            ideasCampaignService.createCampaign(ideaCampaign, userByPrincipal(principal));
        }
    }

    private void createIdeasForCampaign(Principal principal) throws Exception {
        ...
        for (IdeaOut idea : ideas) {
            ...
            IdeaOut ideaOut = ideaService.createNewIdea(campaignId, newIdea, userByPrincipal(principal));
        }
