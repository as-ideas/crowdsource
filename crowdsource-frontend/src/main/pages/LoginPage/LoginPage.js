                    ...
                    <div className="small-12 columns">
                      <h1>
                        ...
                        <small className="right push--top">
                          <NavLink className="text--small" to="/login/password-recovery"><Trans
                            id='LOGIN_LINK_PASSWORD_RECOVERY'>Passwort vergessen?</Trans></NavLink>
                        </small>
                      </h1>
                    </div>
                  </div>
                  ...
                  <div className="row">
                    <div className="small-12 columns text-center">
                      <div>
                        {
                          isLoading ?
                            <button className="button-primary" disabled><Trans
                              id='BUTTON_LABEL_LOGGING_IN'>Login...</Trans></button>
                            :
                            <button className="button-primary"
                                    onClick={() => login(this.state.input.email, this.state.input.password)}><Trans
                              id='BUTTON_LABEL_LOGIN'>Login</Trans></button>
                        }
                      </div>
                      <div className="text--small push--top">
                        <Trans id='LOGIN_REGISTER'
                               values={{link: <NavLink to='/signup'><Trans id='LOGIN_REGISTER_LINK'/></NavLink>}}/>
                      </div>
                    </div>
                  </div>
                </div>
