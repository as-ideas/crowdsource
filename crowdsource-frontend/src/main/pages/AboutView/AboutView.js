  ...
  createReactElement(){
    ...
    <div>
      ...
      <content-row class="ng-scope"><div class="container" ng-transclude="">
          <img src="/images/about/teamfoto.jpg" width="100%" class="ng-scope">
      ...
      <content-row class="ng-scope"><div class="container" ng-transclude="">
          <div class="about__container ng-scope">
              <div class="about__item">
                  ...
                  <social-links class="about__social-links--left" website="https://moveoffice.sharepoint.com/sites/peopleandculture" instagram="https://www.instagram.com/axel_springer_karriere/?hl=de"></social-links>
              </div>
          </div>
      </div></content-row>
