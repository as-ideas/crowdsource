      ...
      <div class="content ng-scope" data-ng-view="" autoscroll="true">
        ...
        <content-row class="ng-scope">
          <div class="container" ng-transclude="">
            <content-hero class="ng-scope ng-isolate-scope">
              <div class="content-hero__container">
                <h2 ng-class="{'content-hero__headline' : description, 'content-hero__headline--solo' : !description}" class="ng-binding content-hero__headline--solo">
                  <Trans id="AS_SUPPORT_HELP_HEADLINE">Hilfe</Trans>
                </h2>
                <p class="content-hero__description ng-binding"></p>
              </div>
            </content-hero>
            <p translate-value-email="<a href='mailto:crowd@asideas.de'>crowd@asideas.de</a>" class="ng-scope">
        ...
        <content-row class="ng-scope">
          <div class="container" ng-transclude="">
            ...
            <ul class="accordion flush ng-scope">
              <accordion-item class="ng-isolate-scope">
                <li class="accordion-navigation accordion-active" ng-class="{ 'accordion-active': accordion.showContent }">
                  <a ng-click="accordion.showContent = !accordion.showContent" class="ng-binding">
                    <Trans id="AS_SUPPORT_FAQ_ACCORDION_ITEM_1_HEADLINE">Was ist die Axel Springer Crowd?</Trans>
                  </a>
                  <div class="content ng-scope" ng-transclude="" ng-if="accordion.showContent">
                    <p class="ng-scope">
